...
export function inspectReleaseCandidate() {
  ...
  if (!Array.isArray(capability.permissions) || capability.permissions.length !== 0) fail("Release candidate must not grant native Tauri capabilities.");
  ...
  return {
    ...
    nativeCapabilities: capability.permissions,
